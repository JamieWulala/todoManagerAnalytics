...
public class testCategories {
    ...
    public void testAddCategories() throws InterruptedException, IOException {
        ...
        String testCaseName = "addCategories";
    ...
    @Test
    public void testUpdateCategories() throws InterruptedException, IOException {

        String testCaseName = "updateCategories";
        String fileName = "output_"+testCaseName;
        int size = SIZE;
        int expectCode = 200;
    ...
    @Test
    public void testDeleteCategories() throws InterruptedException, IOException {

        String testCaseName = "deleteCategories";
        String fileName = "output_"+testCaseName;
        int size = SIZE;
        int expectCode = 200;
