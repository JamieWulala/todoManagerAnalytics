...
public class testProjects {
    ...
    @Test
    public void testAddProjects() throws InterruptedException, IOException {

        String testCaseName = "addProjects";
    ...
    @Test
    public void testUpdateProjects() throws InterruptedException, IOException {

        String testCaseName = "updateProjects";
        String fileName = "output_"+testCaseName;
        int size = SIZE;
        int expectCode = 200;
    ...
    @Test
    public void testDeleteProjects() throws InterruptedException, IOException {

        String testCaseName = "deleteProjects";
        String fileName = "output_"+testCaseName;
        int size = SIZE;
        int expectCode = 200;
